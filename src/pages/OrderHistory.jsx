    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-6">
        <div className="text-center">
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-xl"
          >
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <span
                  className={`inline-flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-full ${status.color}`}
                >
                ...
                {(order?.items || []).map((item, i) => (
                  ...
                  >
                    <span className="text-muted-foreground">
                      {item?.quantity || 0}x {item?.name || "Produk"}
                    </span>
