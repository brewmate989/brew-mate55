...
const navigationMenuTriggerStyle =
  cva(
    ...
    rounded-xl bg-white px-4 py-2 text-sm font-medium
    text-gray-700 transition-all duration-200
    hover:bg-orange-50 hover:text-orange-500
    focus:bg-orange-100 focus:text-orange-600
    focus:outline-none
    disabled:pointer-events-none disabled:opacity-50
    data-[active]:bg-orange-100
    data-[active]:text-orange-600
    ...
    (
      ...
      >
        <NavigationMenuPrimitive.Viewport
          ...
          className={cn(
            `
            origin-top-center relative mt-3
      ...
      >
        <div
          className="
            ...
            h-3 w-3 rotate-45
            rounded-tl-sm
            bg-white border-l border-t border-orange-100
            shadow-sm
          "
        />
      </NavigationMenuPrimitive.Indicator>
