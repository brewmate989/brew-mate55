    ...
    (
      ...
      return (
        <Button
          ...
          size={size}
          className={cn(
            "absolute z-10 h-10 w-10 rounded-full border border-orange-200 bg-white shadow-md transition-all duration-300 hover:scale-105 hover:bg-orange-500 hover:text-white",
            orientation ===
              "horizontal"
